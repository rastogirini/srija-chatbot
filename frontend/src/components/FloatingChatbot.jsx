...
export default function FloatingChatbot({ initialPersona, onViewProduct, onOpenChange, cart, onAddToCart, onDecreaseQty, onShowCart }) {
  ...
  const foodMenu = [
    ...
    { name: 'Gulab Jamun', price: 220, cuisine: 'indian', type: 'dessert', course: 'dessert', protein: 'low', diet: ['vegetarian'], time: ['lunch', 'dinner'], image: 'https://theartisticcook.com/wp-content/uploads/2024/10/Gulab-Jamun-with-Milk-Powder.jpg', description: 'Sweet dumplings in rose syrup', fried: true, nutrition: { protein: 4, calories: 320, carbs: 45 } },
